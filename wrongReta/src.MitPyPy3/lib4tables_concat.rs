...
fn could_be_prime_number_primzahlkreuz(_n: usize) -> bool {
    unimplemented!()
}
fn could_be_prime_number_primzahlkreuz_fuer_innen(_n: usize) -> bool {
    unimplemented!()
}
fn could_be_prime_number_primzahlkreuz_fuer_aussen(_n: usize) -> bool {
    unimplemented!()
}
fn prim_creativity(_n: usize) -> usize {
    unimplemented!()
}
fn moon_number(_n: usize) -> (Vec<usize>, Vec<usize>) {
    unimplemented!()
}
fn prim_multiple(_n: usize) -> Vec<(usize, usize)> {
    unimplemented!()
}
            ...
            if could_be_prime_number_primzahlkreuz_fuer_innen(num) {
                ...
                if num > 16 {
                    let gegen = if keine_primzahl_1 {
                        let g = list2[weiter1b + 1];
                        weiter1b += 1;
                        g
                    } else {
                        let g = list1[weiter1a];
                        weiter1a += 1;
                        g
                    };
