...
\title{5-adischer Steuer-Baum (Blocktree) mit EU-Verteilung}
...
\section{Hierarchie des Baums (5-adisch Blocktree)}
\begin{center}
...
\section{Pseudocode: Steuern, Transfers und Blocktree (5-adisch)}
\begin{verbatim}
...
\section{C++ Implementation (5-adisch)}
...
\section{Java Implementation (5-adisch)}
...
\section{Haskell Implementation (5-adisch)}
