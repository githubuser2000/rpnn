...
\title{3-adischer Steuerbaum mit Blockchain-Hash und Zweckbindung}
\author{Alexander Kern}
\date{\today}

% Listings-Grundkonfiguration
\lstset{
...
\section{Blockchain-Hash}
\[
\text{hash}_\text{node} = H(\text{name}_\text{node} \, \| \, \text{parent\_hash} \, \| \, \big\|_{c \in \text{children}} \text{hash}_c)
\]

\section{Steueraggregation mit Zweckbindung}
\begin{align*}
...
\section{Algorithmus (Pseudocode)}
\begin{verbatim}
