...
pub fn apply_generated_columns(
    ...
    if should_generate_love_polygon(generated_befehle) {
        concat_love_polygon_into_headers_and_data(headers, data, bereich)?;
    }

    if should_generate_gleichheit_freiheit(generated_befehle) {
        concat_gleichheit_freiheit_dominieren_into_headers_and_data(headers, data, bereich)?;
    }

    if should_generate_geist_emotion_energie_materie_topologie(generated_befehle) {
        concat_geist_emotion_energie_materie_topologie_into_headers_and_data(headers, data, bereich)?;
    }

    if should_generate_prim_creativity_type(generated_befehle) {
        concat_prim_creativity_type_into_headers_and_data(headers, data, bereich)?;
    }

    if should_generate_mond_exponzieren_logarithmus_typ(generated_befehle) {
        concat_mond_exponzieren_logarithmus_typ_into_headers_and_data(headers, data, bereich)?;
    }
