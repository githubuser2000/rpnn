...
(vec!["Universum", "universum"], vec!["Primzahlkreuz_pro_contra", "primzahlkreuz"], vec![]),
        ...
        (vec!["Planet(10_und_oder_12)", "planet"], vec!["Herrscher", "herrscher", "korrigierer", "Korrigierer"], vec![536, 542, 548]),
        ...
        (vec!["Galaxie", "galaxie", "alteschriften", "kreis", "galaxien", "kreise"], vec!["Herrscher", "herrscher", "veredler", "Veredler", "Problemlöser", "problemloeser"], vec![537, 538]),
        ...
        (vec!["Menschliches", "menschliches"], vec!["Gesellschaftsschicht", "klasse", "klassen"], vec![241, 551, 555]),
        ...
        (vec!["Koninuum", "kontinuum"], vec!["P", "p", "Sechszehn"], vec![435, 663, 637, 605]),
        (vec!["Kontinuum", "kontinuum"], vec!["P5", "p5", "Sechszehn->Fünf"], vec![501]),
        (vec!["Multiversum", "multiversum"], vec!["P5", "p5", "Sechszehn->Fünf"], vec![501]),
        (vec!["Kontinuum", "kontinuum"], vec!["X", "x", "Vierundzwanzig"], vec![25, 55, 436, 386, 591, 549, 554]),
