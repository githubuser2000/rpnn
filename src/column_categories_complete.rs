...
(vec!["Universum", "universum"], vec!["Primzahlkreuz_pro_contra", "primzahlkreuz"], vec![]),
        ...
        (vec!["Menschliches", "menschliches"], vec!["Bestrafung", "Verbrechen", "verbrechen", "bestrafung"], vec![463, 539, 540]),
        ...
        (vec!["Universum", "universum", "transzendentalien", "strukturalien", "kugel", "kugeln", "ball", "baelle", "bälle"], vec!["Farben"], vec![444, 624, 626]),
