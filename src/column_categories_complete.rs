...
(vec!["Universum", "universum"], vec!["Primzahlkreuz_pro_contra", "primzahlkreuz"], vec![]),
        ...
        (vec!["Planet(10_und_oder_12)", "planet"], vec!["Herrscher", "herrscher", "korrigierer", "Korrigierer", "beherrschen"], vec![536, 542, 548, 562, 590, 603, 604, 617, 664, 665]),
        ...
        (vec!["Galaxie", "galaxie", "alteschriften", "kreis", "galaxien", "kreise"], vec!["Herrscher", "herrscher", "veredler", "Veredler", "Problemlöser", "problemloeser"], vec![537, 538, 590, 603, 604, 617]),
        ...
        (vec!["Grundstrukturen", "grundstrukturen"], vec!["Anführer_Arten(7)"], vec![429, 455, 481, 482, 490, 497, 498, 499, 502, 509, 603]),
