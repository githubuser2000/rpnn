...
(vec!["Universum", "universum"], vec!["Primzahlkreuz_pro_contra", "primzahlkreuz"], vec![]),
        ...
        (vec!["Menschliches", "menschliches"], vec!["Ränge", "Raenge", "ränge", "raenge"], vec![520, 521, 582]),
        ...
        (vec!["Religionen", "religionen", "religion"], vec!["Superkräfte", "Superkraefte"], vec![444, 494, 496, 503, 584]),
