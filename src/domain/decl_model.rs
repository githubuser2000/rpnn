...
impl HtmlSlotLabel {
    fn parse(raw: &str) -> Option<Self> {
        match raw.trim() {
            ...
            "Strukturgrösse" | "Strukturgroesse" => Some(Self::Strukturgroesse),
            "Paradigmen_sind_Absichten_(13)" => Some(Self::ParadigmenSindAbsichten13),
            ...
            "X" => Some(Self::X),
            "Gefühle_(7)" | "Gefuehle_(7)" => Some(Self::Gefuehle7),
            "Anführer" | "Anfuehrer" => Some(Self::Anfuehrer),
            "Organisationen" => Some(Self::Organisationen),
            "Berufe" => Some(Self::Berufe),
            "Lösungen" | "Loesungen" => Some(Self::Loesungen),
            ...
            "gleichförmiges_Polygon" | "gleichfoermiges_Polygon" => Some(Self::GleichfoermigesPolygon),
            "Reziprokes" => Some(Self::Reziprokes),
    ...
    fn render(&self) -> &'static str {
        match self {
            ...
            Self::ParadigmenSindAbsichten13 => "Paradigmen_sind_Absichten_(13)",
            Self::Motive => "Motive",
