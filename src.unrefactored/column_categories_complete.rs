...
pub fn finde_spaltennummern_exakt(&self, ober: &str, unter: &str) -> Vec<u32> {
    ...
    for (haupt_name, unter_map) in &self.hauptkategorien {
        let haupt_normalized: String = haupt_name.to_lowercase().replace("_", "");
...
(vec!["Universum", "universum"], vec!["Primzahlkreuz_pro_contra", "primzahlkreuz"], vec![]),
        ...
        (vec!["Menschliches", "menschliches"], vec!["Feudalwesen", "feudal"], vec![551]),
        (vec!["Menschliches", "menschliches"], vec!["Ränge", "Raenge", "ränge", "raenge"], vec![520, 521, 582, 623]),
        (vec!["Menschliches", "menschliches"], vec!["Psychopath", "Soziopath", "psychopath", "soziopath"], vec![581, 602, 617]),
        (vec!["Menschliches", "menschliches"], vec!["Zeitalter", "zeitalter"], vec![522]),
        (vec!["Menschliches", "menschliches"], vec!["Länderdachorganisationen", "laenderdachorganisationen"], vec![524, 565]),
        (vec!["Menschliches", "menschliches"], vec!["Computerspiele", "computerspiele"], vec![525, 736]),
        (vec!["Menschliches", "menschliches"], vec!["Lebensformen", "lebensformen"], vec![526, 601]),
        (vec!["Menschliches", "menschliches"], vec!["Sinne", "sinn"], vec![533]),
        (vec!["Menschliches", "menschliches"], vec!["Götter", "goetter"], vec![534, 550, 552, 553, 557]),
        (vec!["Menschliches", "menschliches"], vec!["Formationen"], vec![549]),
        (vec!["Religionen", "religionen", "religion"], vec!["Superkräfte", "Superkraefte"], vec![444, 494, 496, 503, 584, 623]),
        (vec!["Galaxie", "galaxie", "alteschriften", "kreis", "galaxien", "kreise"], vec!["Superkräfte", "Superkraefte"], vec![444, 494, 496, 623]),
        ...
        (vec!["Universum", "universum", "transzendentalien", "strukturalien", "kugel", "kugeln", "ball", "baelle", "bälle"], vec!["Naturkreislauf", "kreislauf"], vec![611]),
        (vec!["Menschliches", "menschliches"], vec!["Evolution_vs_Design_intelligent"], vec![519, 657]),
        (vec!["Menschliches", "menschliches"], vec!["Manager", "Management", "manager", "management"], vec![658]),
        (vec!["Menschliches", "menschliches"], vec!["Superkräfte", "Superkraefte"], vec![444, 494, 496, 623]),
        ...
        (vec!["Planet(10_und_oder_12)", "planet"], vec!["Logik", "logik"], vec![725]),
        (vec!["Planet(10_und_oder_12)", "planet"], vec!["Weltordnung", "weltordnung"], vec![733]),
        (vec!["Planet(10_und_oder_12)", "planet"], vec!["Meta-Systeme(12)", "metasysteme", "metasystem", "meta-systeme", "meta-system"], vec![232, 288, 334, 410, 411, 483, 79, 80, 497, 498, 499, 606]),
        (vec!["Planet(10_und_oder_12)", "planet"], vec!["Intelligenz", "intelligenz"], vec![214]),
        (vec!["Planet(10_und_oder_12)", "planet", "Universum", "universum"], vec!["Datenstrukturen", "datenstrukturen"], vec![541]),
        (vec!["Planet(10_und_oder_12)", "planet"], vec!["Intelligenz", "intelligenz"], vec![214]),
        ...
        (vec!["Planet(10_und_oder_12)", "planet"], vec!["Herrscher", "herrscher", "korrigierer", "Korrigierer", "beherrschen"], vec![536, 542, 548, 562, 590, 603, 604, 617, 664, 665, 735]),
        ...
        (vec!["Menschliches", "menschliches"], vec!["Satan_Teufel", "Himmel", "himmel", "Hölle", "hölle"], vec![495, 737]),
        (vec!["Menschliches", "menschliches"], vec!["mono", "stereo", "Mono", "Stereo"], vec![734]),
        ...
        (vec!["Inkrementieren", "inkrementieren"], vec!["Teilchen-Meta-Physik", "addition", "identitaet", "Identität"], vec![219, 223, 307, 308, 333, 387, 388, 406, 606]),
        (vec!["Galaxie", "galaxie", "alteschriften", "kreis", "galaxien", "kreise"], vec!["Hochzüchten", "hochzüchten", "hochzuechten"], vec![318, 319]),
        (vec!["Galaxie", "galaxie", "alteschriften", "kreis", "galaxien", "kreise"], vec!["Herrscher", "herrscher", "veredler", "Veredler", "Problemlöser", "problemloeser"], vec![537, 538, 590, 603, 604, 617, 735]),
        ...
        (vec!["Universum", "universum", "transzendentalien", "strukturalien", "kugel", "kugeln", "ball", "baelle", "bälle"], vec!["Zahlenarten", "zahlen"], vec![462, 563, 717, 728]),
        (vec!["Universum", "universum", "transzendentalien", "strukturalien", "kugel", "kugeln", "ball", "baelle", "bälle"], vec!["Winkel", "winkel"], vec![726]),
        (vec!["Universum", "universum", "transzendentalien", "strukturalien", "kugel", "kugeln", "ball", "baelle", "bälle"], vec!["Morphismus", "morphismus"], vec![727]),
        (vec!["Menschliches", "menschliches"], vec!["Bestrafung", "Verbrechen", "verbrechen", "bestrafung"], vec![463, 539, 540, 636]),
        (vec!["Grundstrukturen", "grundstrukturen"], vec!["Bestrafung", "Verbrechen", "verbrechen"], vec![463, 539, 540, 636]),
        ...
        (vec!["Universum", "universum", "transzendentalien", "strukturalien", "kugel", "kugeln", "ball", "baelle", "bälle"], vec!["Farben"], vec![444, 624, 626, 659]),
        (vec!["Universum", "universum", "transzendentalien", "strukturalien", "kugel", "kugeln", "ball", "baelle", "bälle"], vec!["künstliches_Leben(15)", "künstlichesleben", "grosseki"], vec![409, 601, 606]),
        ...
        (vec!["Universum", "universum", "transzendentalien", "strukturalien", "kugel", "kugeln", "ball", "baelle", "bälle"], vec!["Universelles_Verhältnis_gleicher_Zahlen", "verhaeltnisgleicherzahl"], vec![383, 606]),
        ...
        (vec!["Universum", "universum", "transzendentalien", "strukturalien", "kugel", "kugeln", "ball", "baelle", "bälle"], vec!["Teilchen-Meta-Physik"], vec![219, 308, 606]),
        (vec!["Teilchen-Meta-Physik", "teilchen"], vec!["das_Universelle(15)"], vec![219, 308, 606]),
        ...
        (vec!["Teilchen-Meta-Physik", "teilchen"], vec!["Objekte", "objekte"], vec![546]),
        (vec!["Teilchen-Meta-Physik", "teilchen"], vec!["das_Multiverselle(16)"], vec![388, 418, 606]),
        ...
        (vec!["Grundstrukturen", "grundstrukturen"], vec!["Netzwerk", "netzwerk"], vec![417, 436, 549, 554, 566, 619]),
        ...
        (vec!["Größenordnung", "groessenordnung", "strukturgroesse", "strukturgroeße", "strukturgrösse", "strukturgröße", "groesse", "stufe", "organisationen"], vec!["Licht", "licht"], vec![20, 27, 313, 565]),
        (vec!["Grundstrukturen", "grundstrukturen"], vec!["Strukturgrösse", "Größenordnung", "größe", "groesse", "gross", "strukturgroesse", "strukturgroeße", "strukturgrösse", "strukturgröße"], vec![4, 21, 54, 197, 425, 565, 681]),
        (vec!["Größenordnung", "groessenordnung", "strukturgroesse", "strukturgroeße", "strukturgrösse", "strukturgröße", "groesse", "stufe", "organisationen"], vec!["Strukturgrösse", "Größenordnung", "größe", "groesse", "gross", "strukturgroesse", "strukturgroeße", "strukturgrösse", "strukturgröße"], vec![4, 21, 54, 197, 425, 565, 681]),
        (vec!["Größenordnung", "groessenordnung", "strukturgroesse", "strukturgroeße", "strukturgrösse", "strukturgröße", "groesse", "stufe", "organisationen"], vec!["Organisationen", "organisationen", "organisation"], vec![30, 82, 425, 565, 681]),
        ...
        (vec!["Universum", "universum", "transzendentalien", "strukturalien", "kugel", "kugeln", "ball", "baelle", "bälle"], vec!["Netzwerk", "netzwerk"], vec![25, 55, 386, 390, 549, 554, 566, 619]),
        ...
        (vec!["Universum", "universum", "transzendentalien", "strukturalien", "kugel", "kugeln", "ball", "baelle", "bälle"], vec!["Spezies", "spezies"], vec![661, 669, 721, 732]),
        ...
        (vec!["Menschliches", "menschliches"], vec!["Gesellschaftsschicht", "klasse", "klassen"], vec![241, 551, 555, 584, 697]),
        (vec!["Menschliches", "menschliches"], vec!["Moral", "moral", "warummoral"], vec![215, 216]),
        (vec!["Menschliches", "menschliches"], vec!["Spezies", "spezies"], vec![661, 669, 721, 732]),
        (vec!["Menschliches", "menschliches"], vec!["Karriere", "karriere", "waffen", "Waffen"], vec![594, 595, 596, 597, 713, 714, 715, 716]),
        ...
        (vec!["Wirtschaft", "wirtschaft"], vec!["Kreislaufwirtschaft", "kreislaufwirtschaft", "Kreislauf", "kreislauf"], vec![611]),
        (vec!["Wirtschaft", "wirtschaft"], vec!["Maschinen", "maschinen", "maschine", "gerät", "geräte", "geraete", "geraet"], vec![89, 592, 593, 685, 686, 687]),
        (vec!["Wirtschaft", "wirtschaft"], vec!["Organisationsform", "organisationsform", "organisationsart", "firma", "verein"], vec![99, 565]),
        ...
        (vec!["Menschliches", "menschliches"], vec!["Sinn_des_Lebens", "sinndeslebens", "lebenssinn", "sinn", "sinnsuche"], vec![88, 189, 601]),
        ...
        (vec!["Menschliches", "menschliches"], vec!["Liebe", "liebe", "ethik"], vec![8, 9, 28, 208, 330, 580, 698]),
        (vec!["Menschliches", "menschliches"], vec!["Glaube_Erkenntnis", "glauben", "erkenntnis", "glaube"], vec![59, 621]),
        ...
        (vec!["Grundstrukturen", "grundstrukturen"], vec!["Lebensbereiche_Problemklassen(28)", "lebensbereiche", "lebensfelder", "problemklassen"], vec![405, 415, 416, 601]),
        ...
        (vec!["Grundstrukturen", "grundstrukturen"], vec!["Optimierung(10)", "optimierung"], vec![310, 725]),
        ...
        (vec!["Grundstrukturen", "grundstrukturen"], vec!["Anführer_Arten(7)"], vec![429, 455, 481, 482, 490, 497, 498, 499, 502, 509, 603, 735 ]),
        (vec!["Grundstrukturen", "grundstrukturen"], vec!["Klassen(20)", "klasse", "klassen"], vec![241, 289, 394, 395, 485, 516, 797]),
        ...
        (vec!["Grundstrukturen", "grundstrukturen"], vec!["Verbundenheiten(18)", "verbundenheiten"], vec![252, 299, 300, 336, 580]),
        (vec!["Grundstrukturen", "grundstrukturen"], vec!["Absicht_13_ist_Helfen", "absicht13", "helfen"], vec![370]),
        (vec!["Grundstrukturen", "grundstrukturen"], vec!["Liebe(7)", "liebe"], vec![8, 9, 28, 208, 221, 330, 580, 698]),
        ...
        (vec!["Menschliches", "menschliches"], vec!["Anführer", "anfuehrer", "chef"], vec![29, 170, 429, 455, 490, 502, 509, 564, 603]),
       ...
       (vec!["Symbole", "symbole"], vec!["Religionen"], vec![36, 37]),
        ...
        (vec!["Multiplikationen", "multiplikationen", "Primvielfache", "primvielfache"], vec!["Rahmen-Bedingungen", "rahmen"], vec![226]),
        (vec!["Multiplikationen", "multiplikationen", "Primvielfache", "primvielfache"], vec!["Motive_gleichförmige_Polygone", "motivgleichfoermig"], vec![]),
        (vec!["Multiplikationen", "multiplikationen", "Primvielfache", "primvielfache"], vec!["Struktur_gleichförmige_Polygone", "strukturgleichfoermig"], vec![]),
        (vec!["Multiplikationen", "multiplikationen", "Primvielfache", "primvielfache"], vec!["Motive_Sternpolygone", "motivstern"], vec![]),
        (vec!["Multiplikationen", "multiplikationen", "Primvielfache", "primvielfache"], vec!["Struktur_Sternpolygone", "strukturstern"], vec![]),
        (vec!["Multiplikationen", "multiplikationen", "Primvielfache", "primvielfache"], vec!["Motiv_Sternpolygon_gebrochen-rational", "motivgebrstern"], vec![]),
        (vec!["Multiplikationen", "multiplikationen", "Primvielfache", "primvielfache"], vec!["Struktur_Sternpolyon_gebrochen-rational", "strukgebrstern"], vec![]),
        (vec!["Multiplikationen", "multiplikationen", "Primvielfache", "primvielfache"], vec!["Motiv_gleichförmige_Polygone_gebrochen-rational", "motivgebrgleichf"], vec![]),
        (vec!["Multiplikationen", "multiplikationen", "Primvielfache", "primvielfache"], vec!["Struktur_gleichförmige_Polygone_gebrochen-rational", "strukgebrgleichf"], vec![]),
        (vec!["Multiplikationen", "multiplikationen", "Primvielfache", "primvielfache"], vec!["beschrieben"], vec![]),
        (vec!["Kontinuum", "kontinuum"], vec!["Q", "q", "Siebzehn"], vec![431, 432, 433, 434, 437, 441, 442, 443, 445, 450, 467, 468, 469, 487, 488, 722, 723, 700, 616, 544, 570, 590, 616]),
        ...
        (vec!["Kontinuum", "kontinuum"], vec!["AE", "ae", "Einunddreißig"], vec![530, 612, 613]),
        (vec!["Kontinuum", "kontinuum"], vec!["AD", "ad", "Dreißig"], vec![740, 547, 529, 550, 614]),
        (vec!["Kontinuum", "kontinuum"], vec!["AC", "ac", "Neunundzwanzig"], vec![739, 528, 586]),
        (vec!["Kontinuum", "kontinuum"], vec!["W", "w", "Dreiundzwanzig"], vec![738, 527, 567]),
        (vec!["Kontinuum", "kontinuum"], vec!["i", "I", "Neun"], vec![517, 565]),
        (vec!["Kontinuum", "kontinuum"], vec!["AT", "at", "Sechsundvierzig"], vec![568]),
        (vec!["Kontinuum", "kontinuum"], vec!["z", "Z", "Sechsundzwanzig"], vec![543]),
        (vec!["Kontinuum", "kontinuum"], vec!["G", "g", "Sieben"], vec![518]),
        (vec!["Kontinuum", "kontinuum"], vec!["J", "j", "Zehn"], vec![514]),
        (vec!["Kontinuum", "kontinuum"], vec!["k", "K", "Elf"], vec![515, 705, 578, 577, 709, 710, 711]),
        ...
        (vec!["Kontinuum", "kontinuum"], vec!["Kontinuen", "F", "f", "Sechs", "Alternativen", "Metametaphysik","Meta²Physik", "kontinuuen"], vec![508, 670, 671, 672, 673, 674, 675, 677, 678]),
        ...
        (vec!["Kontinuum", "kontinuum"], vec!["T", "t", "Zwanzig"], vec![486, 571, 572]),
        (vec!["Kontinuum", "kontinuum"], vec!["AB", "ab", "Achtundzwanzig"], vec![587, 583, 619]),
        (vec!["Multiversum", "multiversum"], vec!["P", "p", "Sechszehn", "Dimensionen"], vec![435, 663, 637, 605, 569, 607, 691]),
        (vec!["Kontinuum", "kontinuum"], vec!["P", "p", "Sechszehn"], vec![435, 663, 637, 605, 569, 607, 691]),
        (vec!["Kontinuum", "kontinuum"], vec!["P5", "p5", "Sechszehn->Fünf"], vec![501]),
        (vec!["Multiversum", "multiversum"], vec!["P5", "p5", "Sechszehn->Fünf"], vec![501]),
        (vec!["Kontinuum", "kontinuum"], vec!["X", "x", "Vierundzwanzig"], vec![25, 55, 436, 386, 591, 549, 554, 566, 565, 618, 619]),
        (vec!["Kontinuum", "kontinuum"], vec!["S", "s", "Neunzehn"], vec![504, 575]),
        (vec!["Kontinuum", "kontinuum"], vec!["R", "r", "Achtzehn"], vec![451, 436, 556, 618]),
