...
use crate::table_view_activation_store::{
    ...
    bootstrap_table_view_activation_store as bootstrap_table_view_activation_store_impl,
};
...
use crate::table_view_activation_promotion::{
    TableViewActivationPromotionBundle,
    bootstrap_table_view_activation_promotion as bootstrap_table_view_activation_promotion_impl,
};
        ...
        ArchitectureSnapshotRef {
            ...
            rust_table_view_activation_ledger_validation_status:
                crate::table_view_activation_ledger::continuum_m_activation_ledger_smoke()
                    .validation
                    .status,
            rust_table_view_activation_store_morphism_count: self
                .table_view_activation_store
                .snapshot()
                .morphisms
                .len(),
            rust_table_view_activation_store_smoke_line_count:
                crate::table_view_activation_store::continuum_m_activation_store_smoke()
                    .line_count,
            rust_table_view_activation_store_validation_status:
                crate::table_view_activation_store::continuum_m_activation_store_smoke()
                    .validation
                    .status,
            rust_table_view_activation_persistence_morphism_count: self
                .table_view_activation_persistence
                .snapshot()
                .morphisms
                .len(),
            ...
            rust_table_view_activation_recovery_morphism_count: self
                .table_view_activation_recovery
                .snapshot()
                .morphisms
                .len(),
            ...
            rust_table_view_activation_readiness_validation_status:
                crate::table_view_activation_readiness::continuum_m_activation_readiness_smoke()
                    .status,
            rust_table_view_activation_promotion_morphism_count: self
                .table_view_activation_promotion
                .snapshot()
                .morphisms
                .len(),
            rust_table_view_activation_promotion_validation_status:
                crate::table_view_activation_promotion::continuum_m_activation_promotion_smoke()
                    .status,
...
pub struct ArchitectureSnapshotRef {
    ...
    pub rust_table_view_activation_store_morphism_count: usize,
    pub rust_table_view_activation_store_smoke_line_count: usize,
    ...
    pub rust_table_view_activation_promotion_morphism_count: usize,
    pub rust_table_view_activation_promotion_validation_status: String,
