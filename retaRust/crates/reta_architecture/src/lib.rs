...
pub mod table_view_activation_promotion;
// Stable root-level recovery/readiness/promotion exports are intentionally kept for reta/rreta binaries.
...
pub mod table_view_language_sync;
...
pub use self::table_view_activation_promotion::{
    TableViewActivationPromotionBundle, TableViewActivationPromotionCheck,
    TableViewActivationPromotionPolicy, TableViewActivationPromotionReport,
    TableViewActivationPromotionSnapshot, activation_promotion_checks_from_readiness,
    activation_promotion_for_cli_args, activation_promotion_from_readiness,
    bootstrap_table_view_activation_promotion, continuum_m_activation_promotion_smoke,
};
pub use table_view::{
...
pub use table_view_language_parity::{
    LanguageCellSignature, TableViewLanguageParityBundle, TableViewLanguageParityPolicy,
    TableViewLanguageParityReport, TableViewLanguageParitySnapshot,
...
pub use table_view_language_sync::{
    LanguageColumnSyncAction, TableViewLanguageSyncBundle, TableViewLanguageSyncPolicy,
    TableViewLanguageSyncReport, TableViewLanguageSyncSnapshot, bootstrap_table_view_language_sync,
    continuum_m_language_sync_smoke, language_asset_name_for_sync, language_sync_action,
    language_sync_actions_for_asset, language_sync_for_cli_args, language_sync_from_coverage,
    language_sync_pending_actions_for_cli_args, language_sync_status_for_cli_args, preview_csv_cell,
    preview_text,
};
