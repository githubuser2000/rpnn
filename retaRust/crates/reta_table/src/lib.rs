...
const MANIFEST_JSON: &str = "{\"abi_version\":1,\"library\":\"libreta_table.so\",\"crate\":\"reta_table\",\"role_de\":\"Tabellen-Materialisierung, Tabellenzustand, View-Aufbau und Verklebung lokaler Sektionen.\",\"role_en\":\"Table materialization, table state, view construction, and gluing of local sections.\",\"math_de\":\"Garbe: lokale Spalten-/Zeilen-/Parameter-Sektionen werden zu globalen Tabellen verklebt.\",\"math_en\":\"Sheaf: local column, row, and parameter sections are glued into global tables.\"}\0";
