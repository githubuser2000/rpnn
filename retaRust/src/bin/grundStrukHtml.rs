/*
DIREKT-TRANSCOMPILATIONSFRONT FÜR grundStrukHtml.py
Noch nicht vollständig paritätisch.
Python-Quelle ist unten eingefroren.
*/
...
fn main() {
    eprintln!("grundStrukHtml.rs: nächste Stufe ist line-by-line-Übernahme aus eingefrorener Python-Quelle.");
    std::process::exit(1);
}
