        ...
        crate::reta_arch_shadow::shadow_table_runtime_report_for_program(&program, &argv)
    {
        ...
        if let Some(commit) = view_output_commit.as_ref() {
            diagnostics.push(RetaDiagnostic {
                ...
                message: format!(
                    "Rust-Architektur-Materialized-View-Commit-Gate: mode={} use_view_output={} reason={} gate={} diff_equal={} semantic_equal={} language_ready={} language_asset={} coverage_ready={} coverage_status={} stale_languages={} lines={} rollback={:?}",
                    commit.switch_mode,
        ...
        if let Some(audit) = view_output_audit.as_ref() {
            diagnostics.push(RetaDiagnostic {
                ...
                message: format!(
                    "Rust-Architektur-Commit-Audit: mode={} safe={} use_view_output={} required={}/{} failed={:?} raw_equal={} semantic_equal={} virtual_direct={} virtual_added={} language_ready={} language_asset={} coverage_ready={} coverage_status={} stale_languages={} first_raw_diff={:?} first_semantic_diff={:?}",
                    audit.switch_mode,
        ...
        if let Some(readiness) = view_output_readiness.as_ref() {
            diagnostics.push(RetaDiagnostic {
                ...
                message: format!(
                    "Rust-Architektur-Aktivierungs-Readiness: status={} ready={} level={} source={} required={}/{} raw_equal={} semantic_equal={} virtual_direct={} language_ready={} language_asset={} coverage_ready={} coverage_status={} stale_languages={} failed={:?}",
                    readiness.status,
        ...
        if let Some(promotion) = view_output_promotion.as_ref() {
            diagnostics.push(RetaDiagnostic {
                ...
                message: format!(
                    "Rust-Architektur-Aktivierungs-Promotion: status={} ready={} level={} action={} visible_source={} required={}/{} raw_equal={} semantic_equal={} virtual_direct={} language_ready={} language_asset={} coverage_ready={} coverage_status={} stale_languages={} gate={} failed={:?}",
                    promotion.status,
