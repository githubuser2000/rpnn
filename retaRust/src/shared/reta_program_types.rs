...
pub struct Program {
    ...
    pub CSVsAlreadRead: IndexMap<String, Vec<Vec<String>>>,
    pub BruecheUni: Vec<(i64, i64)>,
    pub BruecheGal: Vec<(i64, i64)>,
    pub BruecheEmo: Vec<(i64, i64)>,
    pub BruecheStrukGroesse: Vec<(i64, i64)>,
...
impl Program {
    pub fn new(argv: Vec<String>) -> Self {
        ...
        Self {
            ...
            generatedSpaltenParameter_Exact: BTreeMap::new(),
            ...
            CSVsAlreadRead: IndexMap::new(),
            BruecheUni: vec![],
            BruecheGal: vec![],
            BruecheEmo: vec![],
            BruecheStrukGroesse: vec![],
            generated1Pairs: vec![],
