...
impl Words {
    pub fn new() -> Self {
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(216), PyValue::Int(215)],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(202), PyValue::Int(138), PyValue::Int(139)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(230), PyValue::Int(105), PyValue::Int(305), PyValue::Int(243), PyValue::Int(283), PyValue::Int(284), PyValue::Int(285), PyValue::Int(286)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(208), PyValue::Int(8), PyValue::Int(9), PyValue::Int(330), PyValue::Int(28)],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(229), PyValue::Int(230), PyValue::Int(167), PyValue::Int(168), PyValue::Int(10), PyValue::Int(42), PyValue::Int(18), PyValue::Int(149)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(304), PyValue::Int(229), PyValue::Int(342), PyValue::Int(231), PyValue::Int(281), PyValue::Int(265)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(257), PyValue::Int(11), PyValue::Int(251)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(32), PyValue::Int(27), PyValue::Int(12), PyValue::Int(13), PyValue::Int(47)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(29), PyValue::Int(502), PyValue::Int(455), PyValue::Int(170), PyValue::Int(490), PyValue::Int(509), PyValue::Int(429)],
                vec![],
                vec![],
                vec![],
                vec![],
