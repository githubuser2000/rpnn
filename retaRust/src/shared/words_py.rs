...
impl Words {
    pub fn new() -> Self {
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Wichtigstes_zum_verstehen".to_string(), "wichtigsteverstehen".to_string()],
            parameterNames: vec!["Wichtigste".to_string(), "wichtigste".to_string()],
            datas: vec![
                vec![PyValue::Int(4), PyValue::Int(5), PyValue::Int(8), PyValue::Int(10)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Menschliches".to_string(), "menschliches".to_string()],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Herrschaft".to_string(), "macht".to_string()],
            parameterNames: vec!["Galaxienclusterherrschaft".to_string(), "cluster".to_string(), "interglaktisch".to_string()],
            datas: vec![
                vec![PyValue::Int(538)],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Herrschaft".to_string(), "macht".to_string()],
            parameterNames: vec!["Herrschaftsformen".to_string(), "formen".to_string(), "Strukturgroesse".to_string(), "groesse".to_string(), "Größe".to_string()],
            datas: vec![
                vec![PyValue::Int(603), PyValue::Int(617)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Herrschaft".to_string(), "macht".to_string()],
            parameterNames: vec!["Orbit-Herrschafts".to_string(), "orbit".to_string(), "Massenmedien".to_string(), "Satelliten".to_string()],
            datas: vec![
                vec![PyValue::Int(548)],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Herrschaft".to_string(), "macht".to_string()],
            parameterNames: vec!["Herrschafts_Datenstruktur".to_string(), "struktur".to_string()],
            datas: vec![
                vec![PyValue::Int(541), PyValue::Int(544)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["MetaMetaPhysik_und_MetaChemie".to_string()],
            parameterNames: vec!["Meta_Meta_Physik_Einteilungen".to_string()],
            datas: vec![
                vec![PyValue::Int(670), PyValue::Int(671), PyValue::Int(672), PyValue::Int(673), PyValue::Int(674), PyValue::Int(675)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Herrschaft".to_string(), "macht".to_string()],
            parameterNames: vec!["Sternen_System".to_string(), "sonne".to_string()],
            datas: vec![
                vec![PyValue::Int(545)],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Herrschaft".to_string(), "macht".to_string()],
            parameterNames: vec!["Galaxieherrschaft".to_string(), "Galaxie".to_string(), "galaxie".to_string()],
            datas: vec![
                vec![PyValue::Int(537), PyValue::Int(604)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Herrschaft".to_string(), "macht".to_string()],
            parameterNames: vec!["abstrakte_Herrschaft".to_string(), "abstrakt".to_string()],
            datas: vec![
                vec![PyValue::Int(564), PyValue::Int(573)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Universum".to_string(), "universum".to_string(), "transzendentalien".to_string(), "strukturalien".to_string(), "kugel".to_string(), "kugeln".to_string(), "ball".to_string(), "baelle".to_string(), "bälle".to_string()],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Planet_(10_und_oder_12)".to_string(), "planet".to_string()],
            parameterNames: vec!["Logik".to_string(), "logik".to_string()],
            datas: vec![
                vec![PyValue::Int(725)],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Planet_(10_und_oder_12)".to_string(), "planet".to_string()],
            parameterNames: vec!["Kreislaufwirtschaft".to_string(), "kreislauf".to_string(), "Kreislauf".to_string()],
            datas: vec![
                vec![PyValue::Int(610)],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Planet_(10_und_oder_12)".to_string(), "planet".to_string()],
            parameterNames: vec!["Planetenherrschaft".to_string(), "herrschaft".to_string(), "Planetenkorrekturherrschaft".to_string()],
            datas: vec![
                vec![PyValue::Int(536), PyValue::Int(542), PyValue::Int(562), PyValue::Int(588), PyValue::Int(664)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Herrschaft".to_string(), "macht".to_string()],
            parameterNames: vec!["Spezies".to_string(), "Speziesherrschaftsformen".to_string()],
            datas: vec![
                vec![PyValue::Int(668), PyValue::Int(669)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Herrschaft".to_string(), "macht".to_string()],
            parameterNames: vec!["Planetenherrschaft".to_string(), "planet".to_string(), "Planetenkorrektur".to_string()],
            datas: vec![
                vec![PyValue::Int(536), PyValue::Int(542), PyValue::Int(562), PyValue::Int(588), PyValue::Int(664)],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Religionen".to_string(), "religionen".to_string(), "religion".to_string()],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Galaxie".to_string(), "galaxie".to_string(), "alteschriften".to_string(), "kreis".to_string(), "galaxien".to_string(), "kreise".to_string()],
            parameterNames: vec!["Superkräfte".to_string(), "Superkraefte".to_string()],
            datas: vec![
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(79), PyValue::Int(80), PyValue::Int(232), PyValue::Int(288), PyValue::Int(334), PyValue::Int(410), PyValue::Int(411), PyValue::Int(483), PyValue::Int(497), PyValue::Int(498), PyValue::Int(499)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(79), PyValue::Int(80), PyValue::Int(132), PyValue::Int(324), PyValue::Int(328), PyValue::Int(331), PyValue::Int(335), PyValue::Int(497), PyValue::Int(498), PyValue::Int(499)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(19), PyValue::Int(65), PyValue::Int(183)],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Wichtigstes_zum_gedanklich_einordnen".to_string(), "wichtigsteeinordnen".to_string()],
            parameterNames: vec!["Wichtigste".to_string(), "wichtigstes".to_string()],
            datas: vec![
                vec![PyValue::Int(0), PyValue::Int(1), PyValue::Int(2), PyValue::Int(36), PyValue::Int(37), PyValue::Int(207)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Operationen".to_string(), "operationen".to_string()],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(72), PyValue::Int(503)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(0), PyValue::Int(6), PyValue::Int(36)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(0), PyValue::Int(36), PyValue::Int(207), PyValue::Int(477), PyValue::Int(478)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(7), PyValue::Int(503)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Inkrementieren".to_string(), "inkrementieren".to_string()],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Multiversum".to_string(), "multiversum".to_string()],
            parameterNames: vec!["Farben".to_string(), "farbe".to_string(), "Farben_Sind_Signale_Signale_sind_Dimension_Dreizehn".to_string()],
            datas: vec![
                vec![PyValue::Int(624), PyValue::Int(659)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Multiversum".to_string(), "multiversum".to_string()],
            parameterNames: vec!["Maschinen".to_string(), "Computer".to_string(), "computer".to_string(), "maschinen".to_string()],
            datas: vec![
                vec![PyValue::Int(89), PyValue::Int(592), PyValue::Int(593), PyValue::Int(685), PyValue::Int(686), PyValue::Int(687)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["MetaMetaPhysik_und_MetaChemie".to_string()],
            parameterNames: vec!["Kybernetik_und_Meta_Chemie".to_string(), "kybernetik".to_string(), "metachemie".to_string()],
            datas: vec![
                vec![PyValue::Int(606)],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(462), PyValue::Int(563), PyValue::Int(704), PyValue::Int(717), PyValue::Int(724), PyValue::Int(728)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(34), PyValue::Int(65), PyValue::Int(382)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Teilchen-Meta-Physik".to_string(), "teilchen".to_string()],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(77), PyValue::Int(145)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(92), PyValue::Int(93), PyValue::Int(315), PyValue::Int(316)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Meta_vs_Konkret_(Universum)".to_string(), "universummetakonkret".to_string()],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Primzahlwirkung".to_string(), "primzahlwirkung".to_string()],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(5), PyValue::Int(54), PyValue::Int(55), PyValue::Int(198), PyValue::Int(390)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            parameterNames: vec!["Netzwerk".to_string(), "netzwerk".to_string()],
            datas: vec![
                vec![PyValue::Int(25), PyValue::Int(55), PyValue::Int(386), PyValue::Int(390)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(4), PyValue::Int(5), PyValue::Int(54), PyValue::Int(165)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Galaxie".to_string(), "galaxie".to_string(), "alteschriften".to_string(), "kreis".to_string(), "galaxien".to_string(), "kreise".to_string()],
            parameterNames: vec!["ZergAliens_MenschenHumanoid_ProtosPraedatoren".to_string()],
            datas: vec![
                vec![PyValue::Int(521)],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(5), PyValue::Int(65), PyValue::Int(166)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(65), PyValue::Int(75), PyValue::Int(203), PyValue::Int(483)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            parameterNames: vec!["Model_of_Hierarchical_Complexity".to_string(), "modelofhierarchicalcomplexity".to_string(), "komplex".to_string(), "komplexität".to_string(), "komplexitaet".to_string(), "complexity".to_string(), "model".to_string(), "abstraktion".to_string()],
            datas: vec![
                vec![PyValue::Int(65), PyValue::Int(75), PyValue::Int(203)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(78), PyValue::Int(79), PyValue::Int(80), PyValue::Int(331), PyValue::Int(497), PyValue::Int(498), PyValue::Int(499)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(76), PyValue::Int(77), PyValue::Int(81), PyValue::Int(104), PyValue::Int(145)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Wirtschaft".to_string(), "wirtschaft".to_string()],
            parameterNames: vec!["Fachgebiete".to_string(), "fachgebiete".to_string(), "fachbereiche".to_string(), "themen".to_string()],
            datas: vec![
                vec![PyValue::Int(183)],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(69), PyValue::Int(70), PyValue::Int(440), PyValue::Int(455), PyValue::Int(476), PyValue::Int(513)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(5), PyValue::Int(131), PyValue::Int(229)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(42), PyValue::Int(131), PyValue::Int(204), PyValue::Int(205), PyValue::Int(231), PyValue::Int(257), PyValue::Int(273), PyValue::Int(281), PyValue::Int(284), PyValue::Int(285), PyValue::Int(326), PyValue::Int(327), PyValue::Int(328), PyValue::Int(329), PyValue::Int(330), PyValue::Int(331), PyValue::Int(332), PyValue::Int(334), PyValue::Int(335), PyValue::Int(338), PyValue::Int(416)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(10), PyValue::Int(42), PyValue::Int(410), PyValue::Int(411), PyValue::Int(493), PyValue::Int(494)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(33), PyValue::Int(290), PyValue::Int(296), PyValue::Int(325), PyValue::Int(326), PyValue::Int(327), PyValue::Int(402), PyValue::Int(403), PyValue::Int(406), PyValue::Int(407), PyValue::Int(408), PyValue::Int(430), PyValue::Int(492)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(241), PyValue::Int(289), PyValue::Int(394), PyValue::Int(395), PyValue::Int(485), PyValue::Int(516), PyValue::Int(697)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(29), PyValue::Int(243), PyValue::Int(283), PyValue::Int(284), PyValue::Int(285), PyValue::Int(286), PyValue::Int(305)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(8), PyValue::Int(9), PyValue::Int(28), PyValue::Int(208), PyValue::Int(221), PyValue::Int(330), PyValue::Int(580)],
                vec![PyValue::Tuple(vec![PyValue::Int(121), PyValue::Int(122)])],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Pro_Contra".to_string(), "procontra".to_string(), "dagegendafuer".to_string()],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Licht".to_string(), "licht".to_string()],
            parameterNames: vec![],
            datas: vec![
                vec![PyValue::Int(20), PyValue::Int(27), PyValue::Int(313)],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Bedeutung".to_string(), "bedeutung".to_string()],
            parameterNames: vec!["Primzahlkreuz_pro_contra".to_string(), "primzahlkreuz".to_string()],
            datas: vec![
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(25), PyValue::Int(45), PyValue::Int(169), PyValue::Int(188), PyValue::Int(386), PyValue::Int(390)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(64), PyValue::Int(154)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["gebrochen-rational_Galaxie_n/m".to_string(), "gebrochengalaxie".to_string()],
            parameterNames: vec!["2".to_string(), "3".to_string(), "4".to_string(), "5".to_string(), "6".to_string(), "7".to_string(), "8".to_string(), "9".to_string(), "10".to_string(), "11".to_string(), "12".to_string(), "13".to_string(), "14".to_string(), "15".to_string(), "16".to_string(), "17".to_string(), "18".to_string(), "19".to_string(), "20".to_string(), "21".to_string(), "22".to_string(), "23".to_string()],
            datas: vec![
                vec![],
                vec![],
                vec![],
                ...
                vec![],
                vec![],
                vec![PyValue::Str("2".to_string()), PyValue::Str("3".to_string()), PyValue::Str("4".to_string()), PyValue::Str("5".to_string()), PyValue::Str("6".to_string()), PyValue::Str("7".to_string()), PyValue::Str("8".to_string()), PyValue::Str("9".to_string()), PyValue::Str("10".to_string()), PyValue::Str("11".to_string()), PyValue::Str("12".to_string()), PyValue::Str("13".to_string()), PyValue::Str("14".to_string()), PyValue::Str("15".to_string()), PyValue::Str("16".to_string()), PyValue::Str("17".to_string()), PyValue::Str("18".to_string()), PyValue::Str("19".to_string()), PyValue::Str("20".to_string()), PyValue::Str("21".to_string()), PyValue::Str("22".to_string()), PyValue::Str("23".to_string())],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["gebrochen-rational_Universum_n/m".to_string(), "gebrochenuniversum".to_string()],
            parameterNames: vec!["2".to_string(), "3".to_string(), "4".to_string(), "5".to_string(), "6".to_string(), "7".to_string(), "8".to_string(), "9".to_string(), "10".to_string(), "11".to_string(), "12".to_string(), "13".to_string(), "14".to_string(), "15".to_string(), "16".to_string(), "17".to_string(), "18".to_string(), "19".to_string(), "20".to_string(), "21".to_string(), "22".to_string(), "23".to_string()],
            datas: vec![
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["gebrochen-rational_Gefuehle_n/m".to_string(), "gebrochenemotion".to_string()],
            parameterNames: vec!["2".to_string(), "3".to_string(), "4".to_string(), "5".to_string(), "6".to_string(), "7".to_string(), "8".to_string(), "9".to_string(), "10".to_string(), "11".to_string(), "12".to_string(), "13".to_string(), "14".to_string(), "15".to_string(), "16".to_string(), "17".to_string(), "18".to_string(), "19".to_string(), "20".to_string(), "21".to_string(), "22".to_string(), "23".to_string()],
            datas: vec![
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["gebrochen-rational_Strukturgroesse_n/m".to_string(), "gebrochengroesse".to_string()],
            parameterNames: vec!["2".to_string(), "3".to_string(), "4".to_string(), "5".to_string(), "6".to_string(), "7".to_string(), "8".to_string(), "9".to_string(), "10".to_string(), "11".to_string(), "12".to_string(), "13".to_string(), "14".to_string(), "15".to_string(), "16".to_string(), "17".to_string(), "18".to_string(), "19".to_string(), "20".to_string(), "21".to_string(), "22".to_string(), "23".to_string()],
            datas: vec![
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Symbole".to_string(), "symbole".to_string()],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Eigenschaften_n".to_string(), "eigenschaften".to_string(), "eigenschaft".to_string(), "konzept".to_string(), "konzepte".to_string()],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Eigenschaften_1/n".to_string(), "konzept2".to_string(), "konzepte2".to_string()],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Multiplikationen".to_string(), "multiplikationen".to_string()],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(431), PyValue::Int(432), PyValue::Int(433), PyValue::Int(434), PyValue::Int(437), PyValue::Int(441), PyValue::Int(442), PyValue::Int(443), PyValue::Int(445), PyValue::Int(450), PyValue::Int(467), PyValue::Int(468), PyValue::Int(469), PyValue::Int(487), PyValue::Int(488), PyValue::Int(544), PyValue::Int(570), PyValue::Int(590), PyValue::Int(616), PyValue::Int(700)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Kontinuum".to_string(), "kontinuum".to_string()],
            parameterNames: vec!["AB".to_string(), "ab".to_string(), "Achtundzwanzig".to_string()],
            datas: vec![
                vec![PyValue::Int(583), PyValue::Int(587)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Kontinuum".to_string(), "kontinuum".to_string()],
            parameterNames: vec!["Z".to_string(), "z".to_string(), "Sechsundzwanzig".to_string()],
            datas: vec![
                vec![PyValue::Int(543)],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Kontinuum".to_string(), "kontinuum".to_string()],
            parameterNames: vec!["AA".to_string(), "aa".to_string(), "Sechsundzwanzig".to_string()],
            datas: vec![
                vec![PyValue::Int(558), PyValue::Int(559), PyValue::Int(560)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(517), PyValue::Int(565), PyValue::Int(681)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(515), PyValue::Int(577), PyValue::Int(578), PyValue::Int(705), PyValue::Int(706), PyValue::Int(707)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Kontinuum".to_string(), "kontinuum".to_string()],
            parameterNames: vec!["AU".to_string(), "au".to_string(), "Siebenundvierzig".to_string()],
            datas: vec![
                vec![PyValue::Int(532)],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Kontinuum".to_string(), "kontinuum".to_string()],
            parameterNames: vec!["AK".to_string(), "ak".to_string(), "Siebenunddreissig".to_string()],
            datas: vec![
                vec![PyValue::Int(531)],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Kontinuum".to_string(), "kontinuum".to_string()],
            parameterNames: vec!["AE".to_string(), "ae".to_string(), "Einunddreissig".to_string()],
            datas: vec![
                vec![PyValue::Int(530), PyValue::Int(612), PyValue::Int(613)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Kontinuum".to_string(), "kontinuum".to_string()],
            parameterNames: vec!["AD".to_string(), "ad".to_string(), "Dreissig".to_string()],
            datas: vec![
                vec![PyValue::Int(529), PyValue::Int(547), PyValue::Int(614)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Kontinuum".to_string(), "kontinuum".to_string()],
            parameterNames: vec!["AC".to_string(), "ac".to_string(), "Neunundzwanzig".to_string()],
            datas: vec![
                vec![PyValue::Int(528), PyValue::Int(586), PyValue::Int(727)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Kontinuum".to_string(), "kontinuum".to_string()],
            parameterNames: vec!["AT".to_string(), "at".to_string(), "Sechsundvierzig".to_string()],
            datas: vec![
                vec![PyValue::Int(568)],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Kontinuum".to_string(), "kontinuum".to_string()],
            parameterNames: vec!["W".to_string(), "w".to_string(), "Dreiundzwanzig".to_string()],
            datas: vec![
                vec![PyValue::Int(527), PyValue::Int(567)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(486), PyValue::Int(571), PyValue::Int(572)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Multiversum".to_string(), "multiversum".to_string()],
            parameterNames: vec!["Religionen_Kraefte_Krieg_der_Sterne_Star_Wars".to_string()],
            datas: vec![
                vec![PyValue::Int(584), PyValue::Int(623)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            parameterMainNames: vec!["Multiversum".to_string(), "multiversum".to_string()],
            parameterNames: vec!["P".to_string(), "p".to_string(), "Sechszehn".to_string(), "Dimensionen".to_string(), "Multiversum_sind_die_Dimensionen".to_string()],
            datas: vec![
                vec![PyValue::Int(435), PyValue::Int(569), PyValue::Int(605), PyValue::Int(637), PyValue::Int(663), PyValue::Int(691)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(25), PyValue::Int(55), PyValue::Int(386), PyValue::Int(436), PyValue::Int(549), PyValue::Int(554), PyValue::Int(565), PyValue::Int(566), PyValue::Int(591), PyValue::Int(618), PyValue::Int(619), PyValue::Int(681)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(504), PyValue::Int(575)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(436), PyValue::Int(451), PyValue::Int(556), PyValue::Int(618)],
                vec![],
                vec![],
                vec![],
                vec![],
        ...
        paraNdataMatrix.push(StoreParameterEntry {
            ...
            datas: vec![
                vec![PyValue::Int(449), PyValue::Int(585)],
                vec![],
                vec![],
                vec![],
                vec![],
