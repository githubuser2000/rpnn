...
pub unsafe extern "C" fn reta_architecture_table_view_virtual_parity_json(
    ...
    match catch_unwind(AssertUnwindSafe(|| {
        ...
        Ok(Err(error)) => json_error_string(&error.to_string()),
        Err(_) => {
            json_error_string("panic inside reta_architecture_table_view_virtual_parity_json")
        }
    }
}
...
pub unsafe extern "C" fn reta_architecture_table_view_activation_replay_json(
    ...
    match catch_unwind(AssertUnwindSafe(|| {
        ...
        let (_, switch_config) =
            reta_architecture::extract_architecture_switch_from_argv(&args, None);
        let policy = reta_architecture::TableViewActivationReplayPolicy::default();
        let replay = reta_architecture::activation_replay_for_cli_args(
            &args,
            &legacy_lines,
            &switch_config,
            &policy,
        ...
        Ok(Err(error)) => json_error_string(&error.to_string()),
        Err(_) => {
            json_error_string("panic inside reta_architecture_table_view_activation_replay_json")
        }
    }
}
...
pub unsafe extern "C" fn reta_architecture_table_view_activation_ledger_json(
    ...
    match catch_unwind(AssertUnwindSafe(|| {
        ...
        let (_, switch_config) =
            reta_architecture::extract_architecture_switch_from_argv(&args, None);
        let policy = reta_architecture::TableViewActivationLedgerPolicy::default();
        let ledger = reta_architecture::activation_ledger_for_cli_args(
            &args,
            &legacy_lines,
            &switch_config,
            &policy,
        ...
        Ok(Err(error)) => json_error_string(&error.to_string()),
        Err(_) => {
            json_error_string("panic inside reta_architecture_table_view_activation_ledger_json")
        }
    }
}
...
pub unsafe extern "C" fn reta_architecture_table_view_activation_store_json(
    ...
    match catch_unwind(AssertUnwindSafe(|| {
        ...
        let parse_report = reta_architecture::parse_activation_store_text(
            &store.store_text,
            &legacy_lines,
        ...
        Ok(Err(error)) => json_error_string(&error.to_string()),
        Err(_) => {
            json_error_string("panic inside reta_architecture_table_view_activation_store_json")
        }
    }
}
...
pub unsafe extern "C" fn reta_architecture_table_view_activation_file_json(
    ...
    match catch_unwind(AssertUnwindSafe(|| {
        ...
        Ok(Ok(json)) => into_c_string(json),
        Ok(Err(error)) => json_error_string(&error.to_string()),
        Err(_) => json_error_string("panic inside reta_architecture_table_view_activation_file_json"),
    }
}
...
pub unsafe extern "C" fn reta_architecture_table_view_activation_recovery_json(
    ...
    match catch_unwind(AssertUnwindSafe(|| {
        ...
        Ok(Ok(json)) => into_c_string(json),
        Ok(Err(error)) => json_error_string(&error.to_string()),
        Err(_) => json_error_string("panic inside reta_architecture_table_view_activation_recovery_json"),
    }
}
...
pub unsafe extern "C" fn reta_architecture_table_view_activation_readiness_json(
    ...
    match catch_unwind(AssertUnwindSafe(|| {
        ...
        Ok(Ok(json)) => into_c_string(json),
        Ok(Err(error)) => json_error_string(&error.to_string()),
        Err(_) => json_error_string("panic inside reta_architecture_table_view_activation_readiness_json"),
    }
}
...
pub unsafe extern "C" fn reta_architecture_table_view_language_parity_json(
    ...
    match catch_unwind(AssertUnwindSafe(|| {
        ...
        Ok(Ok(json)) => into_c_string(json),
        Ok(Err(error)) => json_error_string(&error.to_string()),
        Err(_) => json_error_string("panic inside reta_architecture_table_view_language_parity_json"),
    }
}
...
pub unsafe extern "C" fn reta_architecture_table_view_language_sync_json(
    ...
    match catch_unwind(AssertUnwindSafe(|| {
        ...
        Ok(Ok(json)) => into_c_string(json),
        Ok(Err(error)) => json_error_string(&error.to_string()),
        Err(_) => json_error_string("panic inside reta_architecture_table_view_language_sync_json"),
    }
}
...
pub unsafe extern "C" fn reta_architecture_prompt_language_completion_json(
    ...
    match catch_unwind(AssertUnwindSafe(|| {
        ...
        let report = reta_architecture::prompt_language_completion_for_text(&text, &policy);
        serde_json::to_string(&serde_json::json!({
            "input": text,
            "policy": policy,
            "report": report,
        ...
        Ok(Ok(json)) => into_c_string(json),
        Ok(Err(error)) => json_error_string(&error.to_string()),
        Err(_) => json_error_string("panic inside reta_architecture_prompt_language_completion_json"),
    }
}
...
pub unsafe extern "C" fn reta_architecture_prompt_activation_readiness_json(
    ...
    match catch_unwind(AssertUnwindSafe(|| {
        ...
        let policy = reta_architecture::PromptActivationReadinessPolicy::from_cli_args(&args);
        let report = reta_architecture::prompt_activation_readiness_for_text(
            &text,
            &switch_config,
            &policy,
        );
        ...
        Ok(Ok(json)) => into_c_string(json),
        Ok(Err(error)) => json_error_string(&error.to_string()),
        Err(_) => json_error_string("panic inside reta_architecture_prompt_activation_readiness_json"),
    }
}
...
pub unsafe extern "C" fn reta_architecture_table_view_layout_json(
    ...
    match catch_unwind(AssertUnwindSafe(|| {
        ...
        Ok(Ok(json)) => into_c_string(json),
        Ok(Err(error)) => json_error_string(&error.to_string()),
        Err(_) => json_error_string("panic inside reta_architecture_table_view_layout_json"),
    }
}
...
pub unsafe extern "C" fn reta_architecture_table_view_html_attributes_json(
    ...
    match catch_unwind(AssertUnwindSafe(|| {
        ...
        let html_report = reta_architecture::html_attribute_report_for_rows(
            &view.rows,
        ...
        let output_report =
            reta_architecture::render_materialized_table_view(&view, &output_config);
        serde_json::to_string(&serde_json::json!({
            "args": args,
            "options": options,
            "html_attributes": html_report,
            "output": output_report,
        }))
    })) {
        Ok(Ok(json)) => into_c_string(json),
        Ok(Err(error)) => json_error_string(&error.to_string()),
        Err(_) => {
            json_error_string("panic inside reta_architecture_table_view_html_attributes_json")
        }
    }
}
...
pub unsafe extern "C" fn reta_architecture_table_view_row_styles_json(
    ...
    match catch_unwind(AssertUnwindSafe(|| {
        ...
        Ok(Ok(json)) => into_c_string(json),
        Ok(Err(error)) => json_error_string(&error.to_string()),
        Err(_) => json_error_string("panic inside reta_architecture_table_view_row_styles_json"),
    }
}
...
pub unsafe extern "C" fn reta_architecture_table_view_cell_styles_json(
    ...
    match catch_unwind(AssertUnwindSafe(|| {
        ...
        Ok(Ok(json)) => into_c_string(json),
        Ok(Err(error)) => json_error_string(&error.to_string()),
        Err(_) => json_error_string("panic inside reta_architecture_table_view_cell_styles_json"),
    }
}
...
pub unsafe extern "C" fn reta_architecture_table_view_style_parity_json(
    ...
    match catch_unwind(AssertUnwindSafe(|| {
        ...
        Ok(Ok(json)) => into_c_string(json),
        Ok(Err(error)) => json_error_string(&error.to_string()),
        Err(_) => json_error_string("panic inside reta_architecture_table_view_style_parity_json"),
    }
}
