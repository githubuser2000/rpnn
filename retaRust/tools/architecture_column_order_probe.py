...
def main() -> int:
    ...
    suppressed_visible_columns = [493]
    ...
    checks = {
        ...
        "table_view_order_test_present": "explicit_spaltenreihenfolge_places_virtual_744_before_493" in text["table_view"],
        ...
        "religion_744_is_virtual": 744 >= max_columns,
    }
    ...
    result = {
        ...
        "virtual_column_744_non_direct": 744 >= max_columns,
        "stage26_invariant": "spaltenreihenfolgeundnurdiese order is preserved before rendering; virtual 744 remains a witness unless a virtual-column policy renders it",
    }
