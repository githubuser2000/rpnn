...
def main() -> int:
    ...
    checks = {
        ...
        "religion_max_columns_746": max_columns == 746,
        ...
        "catalog_base_religion_max_columns_746": bool(re.search(r'name: "religion\.csv",.*?max_columns: 746,.*?header_columns: 746,', catalog, re.S)),
