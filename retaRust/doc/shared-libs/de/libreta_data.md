# libreta_data.so — Daten, Wörter, Aliase, CSV-/Katalog-Projektionen

## Kurzfassung für Programmierer

`libreta_data.so` ist die Shared-Library-Grenze für: **Daten, Wörter, Aliase, CSV-/Katalog-Projektionen**.

Diese Komponente ist der Datenraum der Reta-Topologie. Sie enthält echte Alias- und Wörterprojektionen und darf nicht wieder zu einem leeren 494-KB-Stub werden.
...
| Feld | Wert |
|---|---|
| Artefakt | `target/<profile>/libreta_data.so` |
| Crate | `reta_data` |
| Rust-Quelle | `crates/reta_data/src/lib.rs` |
| C-Header | `crates/reta_data/include/reta_data.h` |
| Dokumentation | `doc/shared-libs/de/libreta_data.md` und `doc/shared-libs/en/libreta_data.md` |
...
relationale Basis: Wörter, Aliase und Katalogeinträge sind Objekte; Lookup, Normalisierung und Projektion sind Morphismen.
...
JSON-Strings der Datenfunktionen; mit reta_data_free_string freigeben.
