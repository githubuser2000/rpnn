...
\title{Blocktree-Modelle: 5- & 11-adisch mit Steuererhebung und EU-Verteilung}
...
Dieses Dokument beschreibt die \textbf{Blocktree-Struktur}, die auf Blockchain-Prinzipien basiert, aber \textbf{baumförmig} ist.  
Ziel ist die Simulation von Dorfsteuern, deren Aggregation über Bezirke $\to$ Bundesländer $\to$ Länder $\to$ EU-Länder sowie die Verteilung der Transfers.  

Wir betrachten sowohl \textbf{5-adische} als auch \textbf{11-adische} Strukturen, diskutieren die Programmiersprachen \textbf{Idris2, Zig und Mojo}, und implementieren die Simulation in \textbf{C++, Java und Haskell}.

\section{Sprachvergleich: Idris2, Zig, Mojo}

\begin{itemize}
\item \textbf{Idris2}: Deklarativ, starke Typen, ideal für korrekte Blocktrees und Rekursion über Baumstrukturen.
\item \textbf{Zig}: Low-Level, maximal performant, imperativ; gut für große Simulationen, aber verbose.
\item \textbf{Mojo}: High-Performance, GPU/AI-orientiert; experimentell, ideal für massive Parallelisierung.
\end{itemize}

\section{Blocktree-Prinzip}
...
\section{5-adische Blocktree-Struktur}
...
\section{11-adische Blocktree-Struktur (Dorfsteuern + EU)}
...
\section{EU-Verteilung der Transfers (11 Länder)}

\[
\text{tax}_{\text{EU-Land}} = \frac{\text{tax}_{\text{transfer}}^{\text{Land}}}{11}, \quad 11 \text{ EU-Länder}
\]

\section{Pseudocode: 5- & 11-adisch, Steuern und EU-Verteilung}
...
\section{C++ Implementation (5- & 11-adisch)}
...
\section{Java Implementation (5- & 11-adisch)}
...
\section{Haskell Implementation (5- & 11-adisch)}
